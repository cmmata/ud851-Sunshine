...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            String searchUrlString = params[0];
            ...
            try {
                ...
                String[] simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherSearchResults);
        ...
        protected void onPostExecute(String[] weatherSearchResult) {
            if (weatherSearchResult != null) {
                for (String weatherString : weatherSearchResult) {
