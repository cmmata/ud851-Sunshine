...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar pgLoadingBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorTextView = (TextView) findViewById(R.id.tv_error_data);

        // COMPLETED (17) Find the ProgressBar using findViewById
        pgLoadingBar = (ProgressBar) findViewById(R.id.pg_loading);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pgLoadingBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            pgLoadingBar.setVisibility(View.INVISIBLE);
            if (weatherData != null) {
